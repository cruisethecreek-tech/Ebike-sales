  ...
  const tabs = {
    ...
    'SiteConfig': {
      ...
      rows: [
        ...
        ['social_tiktok',      ''],
        ['social_youtube',     ''],
        ['creek_tuneup_url',   'https://www.cruisethecreek.com/copy-of-buy-an-electric-bike'],
        ['creek_tuneup_external', true],
        ['creek_setup_url',    'https://www.cruisethecreek.com/about-4'],
        ['creek_setup_external', true],
        ['creek_video_url',    'https://www.cruisethecreek.com/remote-video-diagnostics'],
        ['creek_video_external', true],
      ],
    },
    'Sections': {
