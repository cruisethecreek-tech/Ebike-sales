...
.step-icon{width:46px;height:46px;border-radius:50%;background:#3d2e1e;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:.15rem;font-size:1.15rem}
...
.quick-links-inner{max-width:680px;margin:0 auto}
.quick-link-row{display:flex;align-items:center;padding:.7rem 0;border-bottom:1px solid rgba(255,255,255,.28)}
.quick-link-row:last-child{border-bottom:none}
.ql-dot{width:13px;height:13px;border-radius:50%;background:#7a5a3a;margin-right:.9rem;flex-shrink:0}
.ql-label{font-size:.93rem;font-weight:600;color:#1a1a1a;flex:1}
.ql-btn{background:#3d2e1e;color:#fff;font-size:.78rem;font-weight:700;padding:.42rem 1.05rem;border-radius:18px;text-decoration:none;white-space:nowrap;transition:background .18s}
...
.footer-brand{font-weight:800;font-size:1rem;color:#3d2e1e;margin-bottom:.2rem}
.footer-sub{font-size:.78rem;color:#8a7a6a;margin-bottom:1.2rem}
.footer-avail{display:inline-block;background:#3d2e1e;color:#fff;font-weight:700;padding:.68rem 1.9rem;border-radius:24px;text-decoration:none;margin-bottom:1.9rem;font-size:.88rem}
.footer-contacts{display:flex;flex-wrap:wrap;justify-content:center;gap:2rem;margin-bottom:1.6rem}
.footer-col h4{font-size:.72rem;font-weight:700;color:#3d2e1e;text-decoration:underline;margin-bottom:.35rem}
.footer-col p,.footer-col a{font-size:.73rem;color:#5a4a38;display:block;line-height:1.65;text-decoration:none}
.footer-links{display:flex;flex-wrap:wrap;justify-content:center;gap:.4rem 1rem;margin-bottom:1.1rem}
.footer-links a{font-size:.73rem;color:#3d2e1e;text-decoration:underline}
.footer-copy{font-size:.7rem;color:#8a7a6a}

/* ── RESPONSIVE ── */
@media(max-width:700px){
  header{padding:.55rem 1rem;flex-wrap:wrap;gap:.5rem}
  nav a{font-size:.7rem;padding:.3rem .45rem}
  .steps-inner{grid-template-columns:1fr}
  .steps-photo{display:none}
  .trail-cards{grid-template-columns:1fr}
  .trail-card{height:160px}
  .exp-toggle{flex-direction:column;border-radius:14px}
}
</style>
</head>
<body>
...
<section class="hero" id="hero-section">
  ...
  <div class="hero-content">
    ...
    <a href="https://www.cruisethecreek.com/book-a-rental" class="btn-hero" id="hero-cta">Book Your Adventure</a>
  </div>
</section>
...
<section class="experience">
  ...
  <div class="exp-toggle">
    ...
    <button class="exp-btn" data-exp="trailside">#Trailside Journey</button>
  </div>
  <div class="exp-location" id="exp-location">Bears Den Rd, Youngstown &bull; Park &amp; Pickup at Scholl Pavilion</div>
  <div>
    <a href="https://www.cruisethecreek.com/book-a-rental" class="btn-avail" id="exp-avail">Check Availability</a>
    <a href="#trailside" class="btn-switch" id="exp-switch">Switch to #Trailside Journey &rarr;</a>
  </div>
</section>
...
<section class="steps-section">
  <div class="steps-inner">
    <div>
      <div class="steps-head">Book Your Trip in 3 Easy Steps</div>
      <div class="steps-list">
        ...
        <div class="step">
          ...
          <div><span class="step-num">02</span><h3>Get Started</h3><p>Receive an email with contact details, basic info &amp; waiver forms</p></div>
        </div>
        <div class="step">
          <div class="step-icon">&#x1F6B2;</div>
...
<footer>
  ...
  <a href="https://www.cruisethecreek.com/book-a-rental" class="footer-avail">Check Availability</a>
  <div class="footer-contacts">
    ...
    <div class="footer-col">
      ...
      <p>Park at the Bottom of the hill, walk up to Kirk Road Trailhead</p>
    </div>
  </div>
...
const EXP = {
  unleash: {
    ...
    headline: '#Unleash Your<br>Adventure',
    sub: 'Adventure Awaits! Rent an electric bike and experience the sights and sounds of the park in a new and exciting way!',
    cta: 'Book Your Adventure',
    location: 'Bears Den Rd, Youngstown • Park &amp; Pickup at Scholl Pavilion',
    avail: 'Check Availability',
    switchLabel: 'Switch to #Trailside Journey →',
    switchTarget: '#trailside',
    url: 'https://www.cruisethecreek.com/book-a-rental',
  },
  trailside: {
    tag: 'Kirk Road Trailhead • Canfield, OH',
    headline: '#Trailside<br>Journey',
    sub: 'Explore 11 miles of scenic trail on an electric bike. Pick up at the Kirk Road Trailhead and discover Mill Creek at your own pace.',
    cta: 'Book Trailside Journey',
    location: '6685 Kirk Rd, Canfield • Park at bottom of hill, walk up to trailhead',
    avail: 'Check Trailside Availability',
    switchLabel: 'Switch to #Unleash Your Adventure →',
    switchTarget: '#hero-section',
    url: 'https://www.cruisethecreek.com/book-a-rental',
  }
};
...
with open('adventures.html', 'w') as f:
    f.write(html)
print(f"adventures.html written ({len(html.splitlines())} lines of HTML).")
